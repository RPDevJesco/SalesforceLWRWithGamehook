...
function initDistortionCSSStyleRuleStyleGetter$LWS({
  ...
  const distortionEntry$LWS = [originalStyleGetter$LWS, function style$LWS() {
    return shared$LWS.trackTargetAsLive(shared$LWS.ReflectApply(originalStyleGetter$LWS, this, []));
  }];
...
function initDistortionCustomElementRegistryGet$LWS({
  ...
  return function distortionCustomElementRegistryGet$LWS({
    ...
    const loweredNsPrefix$LWS = `${shared$LWS.ReflectApply(shared$LWS.StringProtoToLowerCase, key$LWS, [])}-`;
    return [originalGet$LWS, function get$LWS(...args$LWS) {
      ...
      if (args$LWS.length) {
        ...
        if (!shared$LWS.ReflectApply(shared$LWS.StringProtoStartsWith, loweredName$LWS, [loweredNsPrefix$LWS])) {
          return undefined;
        }
...
function initDistortionDocumentReplaceChildren$LWS({
  ...
  const distortionEntry$LWS = [originalReplaceChild$LWS, function replaceChildren$LWS(...args$LWS) {
    ...
    // istanbul ignore else: needs default platform behavior test
    if (isSharedElement$l$LWS(shared$LWS.ReflectApply(sharedDom$LWS.DocumentProtoHeadGetter, this, []))) {
    ...
    if (isSharedElement$k$LWS(this)) {
      for (let i$LWS = 0, {
        ...
        if (!isAllowedSharedElementChild$6$LWS(argValue$LWS)) {
          const nodeNameOrString$LWS = argValue$LWS instanceof Node$LWS ? shared$LWS.ReflectApply(sharedDom$LWS.NodeProtoNodeNameGetter, argValue$LWS, []) :
          /* istanbul ignore next: currently unreachable via tests */
          shared$LWS.toString(argValue$LWS);
...
function initDistortionElementInnerHTMLSetter$LWS({
  ...
  const originalInnerHTMLSetter$LWS = shared$LWS.ObjectLookupOwnSetter(Element$LWS.prototype, 'innerHTML');
...
function initDistortionElementShadowRootGetter$LWS({
  ...
  const distortionEntry$LWS = [originalShadowRootGetter$LWS, shared$LWS.alwaysNull];
    ...
    return [originalToggleAttribute$LWS, function toggleAttribute$LWS(...args$LWS) {
      ...
      if (length$LWS > 0) {
        ...
        if (distortion$LWS) {
          ...
          shared$LWS.ReflectApply(distortion$LWS, this, distortionArgs$LWS); // If the distortion does not throw, then we need to
    ...
    function addEventListener$LWS(...args$LWS) {
      ...
      if (length$LWS > 1) {
        ...
        if (isEventTargetRestricted$LWS(record$LWS, this, eventName$LWS)) {
          ...
          const safeDesc$LWS = shared$LWS.ReflectGetOwnPropertyDescriptor(this.constructor, 'name'); // istanbul ignore else: needs default platform behavior test
  ...
  return function distortionFunction$LWS({
    ...
    return [originalFunction$LWS, function Function$LWS(...args$LWS) {
      ...
      if (length$LWS) {
        ...
        args$LWS[lastIndex$LWS] = sharedDom$LWS.transformSourceText(shared$LWS.toString(args$LWS[lastIndex$LWS]));
...
function initDistortionHistoryPushState$LWS({
  ...
  const distortionEntry$LWS = [originalPushState$LWS, function pushState$LWS(...args$LWS) {
    if (args$LWS.length) {
      args$LWS[0] = shared$LWS.partialStructuredClone(args$LWS[0]);
    }
...
function initDistortionHTMLElementDatasetGetter$LWS({
  ...
  const distortionEntry$LWS = [originalDatasetGetter$LWS, function dataset$LWS() {
    return shared$LWS.trackTargetAsLive(shared$LWS.ReflectApply(originalDatasetGetter$LWS, this, []));
  }];
...
} = sharedDom$LWS.rootValidator; // The outerText property is non-standard, so the descriptor could be undefined,
...
function defineEvaluatorProperty$LWS(host$LWS, callback$LWS) {
  if (!shared$LWS.ReflectDefineProperty(host$LWS, SCRIPT_EVALUATOR_PROPERTY_NAME$LWS, {
    __proto__: null,
    configurable: true,
    ...
    get: shared$LWS.ReflectApply(shared$LWS.FunctionProtoBind, () => {
      shared$LWS.ReflectDeleteProperty(host$LWS, SCRIPT_EVALUATOR_PROPERTY_NAME$LWS);
      const ownerDoc$LWS = shared$LWS.ReflectApply(sharedDom$LWS.NodeProtoOwnerDocumentGetter, host$LWS, []);
      const defaultView$LWS = shared$LWS.ReflectApply(sharedDom$LWS.DocumentProtoDefaultViewGetter, ownerDoc$LWS, []); // We don't need to use something like `WindowLocationGetter()`
    ...
    throw new shared$LWS.LockerSecurityError(`Cannot evaluate ${shared$LWS.ReflectApply(sharedDom$LWS.NodeProtoNodeNameGetter, host$LWS, [])}`);
  }
}
...
function defineSrcEvaluatorProperty$LWS(host$LWS, sandboxEvaluator$LWS) {
  ...
  defineEvaluatorProperty$LWS(host$LWS, (context$LWS, defaultView$LWS, ownerDoc$LWS, {
    ...
    sandboxEvaluator$LWS(sharedDom$LWS.transformSourceText(sharedDom$LWS.WindowDecodeURIComponent(shared$LWS.toString(encodedPayload$LWS))), context$LWS, defaultView$LWS, ownerDoc$LWS);
  });
  return true;
}
...
function defineTextContentEvaluatorProperty$LWS(host$LWS, textContent$LWS, sandboxEvaluator$LWS) {
  ...
  defineEvaluatorProperty$LWS(host$LWS, (context$LWS, defaultView$LWS, ownerDoc$LWS) => {
    sandboxEvaluator$LWS(sharedDom$LWS.transformSourceText(textContent$LWS), context$LWS, defaultView$LWS, ownerDoc$LWS);
  });
  return true;
}
...
function getSrcEvaluatorHookSourceText$LWS(sourceText$LWS) {
  ...
  return sharedDom$LWS.URLCreateObjectURL(new sharedDom$LWS.BlobCtor([shared$LWS.ReflectApply(shared$LWS.StringProtoReplace, SCRIPT_HOOK_SRC_SOURCE_TEXT$LWS, [SCRIPT_PAYLOAD_TOKEN$LWS, sharedDom$LWS.WindowEncodeURIComponent(sourceText$LWS)])], BLOB_SCRIPT_OPTIONS$LWS));
}

const getTextContentEvaluatorHookSourceText$LWS = () => SCRIPT_HOOK_TEXT_CONTENT_SOURCE_TEXT$LWS;

const documentToPropertyDescriptorRegistryMap$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
...
function createBlockedAttributeDistortionFactoryInitializer$LWS(Ctor$LWS, ctorName$LWS, attributeName$LWS) {
  return function initDistortionBlockedAttribute$LWS() {
    ...
    return function distortionBlockedAttribute$LWS(record$LWS) {
      registerElementSetDistortion$LWS(record$LWS, Ctor$LWS, attributeName$LWS, sharedDom$LWS.NAMESPACE_DEFAULT, distortion$LWS);
      return null;
    };
  };
}
...
function createBlockedPropertyDistortionFactoryInitializers$LWS({
  ...
  if (descRegistryMap$LWS === undefined) {
    descRegistryMap$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
  ...
  for (let i$LWS = 0, {
    ...
    if (safeDesc$LWS === undefined) {
      ...
      safeDesc$LWS = (_ReflectGetOwnPropert$LWS = shared$LWS.ReflectGetOwnPropertyDescriptor(proto$LWS, prop$LWS)) != null ? _ReflectGetOwnPropert$LWS : null;
...
function createScriptDistortion$LWS({
  ...
  const distortionName$LWS = `script${shared$LWS.capitalizeFirstChar(attributeName$LWS)}`; // Use a computed property to dynamically set the distortion function name
  ...
  const {
    ...
    [distortionName$LWS](value$LWS) {
      ...
      shared$LWS.ReflectApply(sharedDom$LWS.HTMLAnchorElementProtoHrefSetter, sharedUrl$LWS.normalizerAnchor, [value$LWS]);
      value$LWS = shared$LWS.ReflectApply(sharedDom$LWS.HTMLAnchorElementProtoHrefGetter, sharedUrl$LWS.normalizerAnchor, []); // Create a dataset attribute to expose the undistorted attribute value.
      ...
      shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, xhr$LWS, ['load', () => {
        ...
        if (status$LWS === 200) {
          if (defineSrcEvaluatorProperty$LWS(this, sandboxEvaluator$LWS)) {
            const responseText$LWS = shared$LWS.ReflectApply(sharedDom$LWS.XhrProtoResponseTextGetter, xhr$LWS, []); // Set and run the src evaluator hook.

            shared$LWS.ReflectApply(sharedDom$LWS.ElementProtoSetAttributeNS, this, [attributeNamespaceURI$LWS, attributeName$LWS, getSrcEvaluatorHookSourceText$LWS(responseText$LWS)]);
          }
        } else {
...
function initDistortionJSONParse$LWS({
  ...
  return function distortionJSONParse$LWS({
    ...
    return [originalParse$LWS, function parse$LWS(...args$LWS) {
      const result$LWS = shared$LWS.ReflectApply(originalParse$LWS, this, args$LWS);

      if (typeof result$LWS === 'object' && result$LWS !== null) {
        trackAsFastTarget$LWS(result$LWS);
      }
...
function initDistortionNodeTextContentSetter$LWS({
  ...
  const originalTextContentSetter$LWS = shared$LWS.ObjectLookupOwnSetter(Node$LWS.prototype, 'textContent');
  return function distortionNodeTextContentSetter$LWS(record$LWS) {
    ...
    return [originalTextContentSetter$LWS, function textContent$LWS(value$LWS) {
      const valueAsString$LWS = shared$LWS.toString(value$LWS); // There are two existence of the attribute textContent, one on
      ...
      if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement$LWS) {
        if (defineTextContentEvaluatorProperty$LWS(this, valueAsString$LWS, (sourceText$LWS, context$LWS, globalObject$LWS, document$LWS) => {
          ...
          shared$LWS.ReflectApply(originalTextContentSetter$LWS, this, [getTextContentEvaluatorHookSourceText$LWS()]);
          return;
        }
      } // istanbul ignore else: needs default platform behavior test
...
function initDistortionNotificationCtor$LWS({
  ...
  const distortionEntry$LWS = [originalNotificationCtor$LWS, function Notification$LWS(...args$LWS) {
    if (args$LWS.length > 1) {
      args$LWS[1] = shared$LWS.partialStructuredClone(args$LWS[1]);
    }
  ...
  const proxy$LWS = new shared$LWS.ProxyCtor(storageTarget$LWS, {
    ...
    getOwnPropertyDescriptor(target$LWS, key$LWS) {
      ...
      if (typeof key$LWS === 'symbol') {
        ...
        const keyForNamespace$LWS = getStorageKeyForNamespace$LWS(storageRootKey$LWS, key$LWS);
        safeDesc$LWS = shared$LWS.ReflectGetOwnPropertyDescriptor(storage$LWS, keyForNamespace$LWS);
      }
...
function createStorage$LWS(storage$LWS, storageRootKey$LWS) {
  ...
  shared$LWS.trackTargetAsLive(proxy$LWS);
...
function initDistortionSVGAnimateElementAttributeNameAttribute$LWS({
  ...
  return function distortionSVGAnimateElementAttributeNameAttribute$LWS(record$LWS) {
    ...
    registerElementSetDistortion$LWS(record$LWS, SVGAnimateElement$LWS, 'attributeName', sharedDom$LWS.NAMESPACE_DEFAULT, function attributeName$LWS(value$LWS) {
...
function initDistortionURLCreateObjectURL$LWS({
  ...
  } = sharedDom$LWS.getValidator(globalObject$LWS, document$LWS);
...
function initDistortionWindowGetComputedStyle$LWS({
  ...
  const distortionEntry$LWS = [originalGetComputedStyle$LWS, function getComputedStyle$LWS(...args$LWS) {
    return shared$LWS.trackTargetAsLive(shared$LWS.ReflectApply(originalGetComputedStyle$LWS, this, args$LWS));
  }];
    ...
    return [originalSetInterval$LWS, function setInterval$LWS(...args$LWS) {
      if (args$LWS.length) {
        ...
        if (callback$LWS !== null && callback$LWS !== undefined && typeof callback$LWS !== 'function') {
          ...
          const sourceText$LWS = shared$LWS.toString(callback$LWS); // Defer transforming source text asynchronously.
  ...
  return function distortionWindowSetTimeout$LWS({
    ...
    return [originalSetTimeout$LWS, function setTimeout$LWS(...args$LWS) {
      if (args$LWS.length) {
        ...
        if (callback$LWS !== null && callback$LWS !== undefined && typeof callback$LWS !== 'function') {
          // Snapshot callback source to prevent shapeshifting.
          const sourceText$LWS = shared$LWS.toString(callback$LWS); // Replace callback parameter.
...
const externalDistortionFactoryInitializers$LWS = shared$LWS.ArrayConcat(internalDistortionFactoryInitializers$LWS, [// Element
...
function isNearMembrane$LWS(__value$LWS) {
...
ArrayIsArray$LWS(brands$LWS) && brands$LWS.length ? // Use user-agent client hints API if available to avoid deprecation
// warnings.
...
const DocumentProtoBodyGetter$LWS = ObjectLookupOwnGetter$LWS(DocumentProto$LWS, 'body'); // The DOMException constructor was exposed in Edge 12 but wasn't invocable
...
const NodeProtoLastChildGetter$LWS = ObjectLookupOwnGetter$LWS(NodeProto$LWS, 'lastChild'); // replacement logic. Instead of customizing each build system to be aware
// of this package we implement a two phase debug mode by performing small
// runtime checks to determine phase one, our code is unminified, and
// phase two, the user opted-in to custom devtools formatters. Phase one
// is used for light weight initialization time debug while phase two is
...
function createMembraneMarshall$LWS(_globalObject$LWS) {
  ...
  const localEval$LWS = IS_IN_SHADOW_REALM$LWS ? eval : undefined; // Install flags to ensure things are installed once per realm.
  ...
  return function createHooksCallback$LWS(color$LWS, foreignCallableHooksCallback$LWS, options$LWS) {
    ...
    const isForeignPointerOfTypedArrayProto$LWS = IS_IN_SHADOW_REALM$LWS ? // eslint-disable-next-line no-return-assign
    ...
    class BoundaryProxyHandler$LWS {
      ...
      static passthruDefinePropertyTrap(_shadowTarget$LWS, __key$LWS, _unsafePartialDesc$LWS) {
        ...
        const valuePointerOrPrimitive$LWS = 'value' in safePartialDesc$LWS ? // Inline getTransferableValue().
        typeof __value$LWS === 'object' && __value$LWS !== null || typeof __value$LWS === 'function' ? getTransferablePointer$LWS(__value$LWS) : // Intentionally ignoring `document.all`.
        // https://developer.mozilla.org/en-US/docs/Web/API/Document/all
        // https://tc39.es/ecma262/#sec-IsHTMLDDA-internal-slot
        typeof __value$LWS === 'undefined' ? undefined : __value$LWS : LOCKER_NEAR_MEMBRANE_UNDEFINED_VALUE_SYMBOL$LWS;
        const getterPointerOrUndefinedSymbol$LWS = 'get' in safePartialDesc$LWS ? // Inline getTransferableValue().
        ...
        const setterPointerOrUndefinedSymbol$LWS = 'set' in safePartialDesc$LWS ? // Inline getTransferableValue().
    ...
    BoundaryProxyHandler$LWS.hybridGetTrap = IS_IN_SHADOW_REALM$LWS ? function (_shadowTarget$LWS, __key$LWS, __receiver$LWS) {
      ...
      if (_safeDesc$LWS === undefined && _result$LWS === undefined && __key$LWS === SymbolToStringTag$LWS && foreignTargetTraits$LWS & 16
      /* TargetTraits.IsObject */
      ) {
        let toStringTag$LWS;
    ...
    BoundaryProxyHandler$LWS.hybridGetTrapForTypedArray = IS_IN_SHADOW_REALM$LWS ? function (_shadowTarget$LWS, __key$LWS, __receiver$LWS) {
      ...
      if (!useFastPath$LWS && typeof __key$LWS === 'string') {
        ...
        useFastPath$LWS = _possibleIndex$LWS > -1 && _possibleIndex$LWS < foreignTargetTypedArrayLength$LWS && NumberIsInteger$LWS(_possibleIndex$LWS);
      }
    ...
    !IS_IN_SHADOW_REALM$LWS && liveTargetCallback$LWS ? (targetPointer$LWS, targetTraits$LWS) => {
      ...
      if (__target$LWS !== ObjectProto$LWS && __target$LWS !== RegExpProto$LWS) {
        try {
...
class VirtualEnvironment$LWS {
  constructor(options$LWS) {
    ...
    const {
      ...
      24: redCallableGetPropertyValue$LWS,
    ...
    redCallableGetLazyPropertyDescriptorStateByTarget$LWS, redCallableGetPropertyValue$LWS, redCallableGetTargetIntegrityTraits$LWS, redCallableGetToStringTagOfTarget$LWS, redCallableInstallErrorPrepareStackTrace$LWS, noop$LWS, // redCallableInstallLazyPropertyDescriptors,
    redCallableIsTargetLive$LWS, redCallableIsTargetRevoked$LWS, redCallableSerializeTarget$LWS, redCallableSetLazyPropertyDescriptorStateByTarget$LWS, redCallableTrackAsFastTarget$LWS, redCallableBatchGetPrototypeOfAndGetOwnPropertyDescriptors$LWS, redCallableBatchGetPrototypeOfWhenHasNoOwnProperty$LWS, redCallableBatchGetPrototypeOfWhenHasNoOwnPropertyDescriptor$LWS);
    ...
    blueCallableGetLazyPropertyDescriptorStateByTarget$LWS, blueCallableGetPropertyValue$LWS, blueCallableGetTargetIntegrityTraits$LWS, blueCallableGetToStringTagOfTarget$LWS, blueCallableInstallErrorPrepareStackTrace$LWS, noop$LWS, // blueCallableInstallLazyPropertyDescriptors,
    blueCallableIsTargetLive$LWS, blueCallableIsTargetRevoked$LWS, blueCallableSerializeTarget$LWS, blueCallableSetLazyPropertyDescriptorStateByTarget$LWS, noop$LWS, // blueCallableTrackAsFastTarget,
    ...
    this.redCallableTrackAsFastTarget = redCallableTrackAsFastTarget$LWS;
  }
...
const HELPERS_SOURCE_TEXT$LWS = `'use strict';
        ${shared$LWS.SANDBOX_EVAL_CONTEXT_NAME}(${function redHelpersFactory$LWS(_context$LWS) {
  const {
...
const policyOptions$LWS = {
  ...
  createScriptURL: (unsafe$LWS, options$LWS) => {
    ...
    if (lwsTTOpts$LWS) {
      ...
      const _url$LWS = sharedUrl$LWS.normalizeUrl(unsafe$LWS);
      shared$LWS.ReflectDefineProperty(targetElement$LWS, 'runScript', {
        // @ts-ignore
        __proto__: null,
        configurable: true,
        get: async () => {
          shared$LWS.ReflectDeleteProperty(targetElement$LWS, 'runScript');
          let _event$LWS;
          ...
          try {
            ...
            const _response$LWS = await sharedDom$LWS.WindowFetch(_url$LWS, {
              __proto__: null,
              credentials: 'include'
            });
            const _status$LWS = shared$LWS.ReflectApply(sharedDom$LWS.ResponseProtoStatus, _response$LWS, []);

            if (_status$LWS !== 200) {
              const text$LWS = shared$LWS.ReflectApply(sharedDom$LWS.ResponseProtoStatusText, _response$LWS, []);
              throw new shared$LWS.ErrorCtor(text$LWS);
            }

            const text$LWS = await shared$LWS.ReflectApply(sharedDom$LWS.ResponseProtoText, _response$LWS, []);
            evaluator$LWS(text$LWS);
            _event$LWS = new sharedDom$LWS.EventCtor('load');
          } catch (error) {
            _event$LWS = new sharedDom$LWS.ErrorEventCtor('error', {
              error
            });
          } finally {
            // cleanup
            shared$LWS.ReflectSet(targetElement$LWS, 'textContent', '');
            shared$LWS.ReflectDeleteProperty(targetElement$LWS, 'src');
            shared$LWS.ReflectSet(targetElement$LWS, 'src', _url$LWS);
            shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoDispatchEvent, targetElement$LWS, [_event$LWS]);
          }
        }
      });
      ...
      shared$LWS.ReflectDefineProperty(targetElement$LWS, 'src', {
        // @ts-ignore
        __proto__: null,
        configurable: true,
        enumerable: true,
...
const IFRAME_KEEP_ALIVE_FLAG$LWS = shared$LWS.LOCKER_UNMINIFIED_FLAG && sharedDom$LWS.IS_CHROMIUM_BROWSER && !sharedDom$LWS.IS_HEADLESS_CHROMIUM_BROWSER; // WebKit based browsers have a bug that prematurely removes distortion entries
...
} = sharedDom$LWS.rootWindow; // Fast path non-configurable document, location, and window objects in the
// virtual environment distortion callback by seeding them in the root window's
// created distortion map.

const rootDistortionMapSeedEntries$LWS = [[sharedDom$LWS.rootDocument, sharedDom$LWS.rootDocument], [rootLocation$LWS, rootLocation$LWS], [sharedDom$LWS.rootWindow, sharedDom$LWS.rootWindow]];
const rootSandboxRegistry$LWS = {
  __proto__: null
};
const documentToSandboxRegistry$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor([[sharedDom$LWS.rootDocument, rootSandboxRegistry$LWS]]));
const documentToEvaluationDistortionFactoriesMap$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
const elementToLoadingPromiseMap$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
const opaqueToDistortionFactoriesMap$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
const opaqueToSandboxRegistry$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
const rendererFactoryToRendererMap$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
...
const EMPTY_HELPERS$LWS = {
  ...
  makeRedResyncImports: shared$LWS.noop,
...
const ROOT_UNCOMPILED_CONTEXT$LWS = {
  [shared$LWS.UNCOMPILED_LOCATION_NAME]: rootLocation$LWS,
  [shared$LWS.UNCOMPILED_TOP_NAME]: sharedDom$LWS.topWindow
};
...
function createSecondaryWindowSandboxRecord$LWS({
  ...
  _record$LWS = {
    ...
    UNCOMPILED_CONTEXT: {
      ...
      [shared$LWS.UNCOMPILED_TOP_NAME]: _globalObject$LWS.top
    },
    context: _context$LWS,
    document: _document$LWS,
    ...
    trackAsFastTarget: shared$LWS.noop,
    type: _type$LWS,
  ...
  const frameElement$LWS = shared$LWS.ReflectApply(sharedDom$LWS.WindowFrameElementGetter, _globalObject$LWS, []);

  if (frameElement$LWS) {
    // Create a new sandbox record when the iframe window location changes.
    shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, frameElement$LWS, ['load', onDOMContentLoadedOrWindowLoad$LWS, // useCapture
    true]);
  } else {
    ...
    shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, _globalObject$LWS, ['unload', function onWindowUnload$LWS() {
      sharedDom$LWS.WindowQueueMicrotask(() => {
        try {
          ...
          if (_document$LWS !== newDocument$LWS) {
            shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, _globalObject$LWS, ['DOMContentLoaded', onDOMContentLoadedOrWindowLoad$LWS, true]);
            shared$LWS.ReflectApply(sharedDom$LWS.EventTargetProtoAddEventListener, _globalObject$LWS, ['unload', onWindowUnload$LWS, true]);
          }
        } catch (_unused37$LWS) {
          // istanbul ignore next: this is a safety precaution that is unreachable via tests
          createOpaqueSecondaryWindowSandboxRecord$LWS({
...
function createDistortionMap$LWS(entries$LWS) {
  return SUPPORTS_DISTORTIONS_WEAK_MAP$LWS ? shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor(entries$LWS)) : // istanbul ignore next: this code is not reachable in the coverage run.
...
function createVirtualEnvironmentEvaluator$LWS(_record$LWS, getVirtualEnvironment$LWS) {
  ...
  return _sourceText$LWS => {
    if (virtualEnvironment$LWS === undefined) {
      virtualEnvironment$LWS = getVirtualEnvironment$LWS(); // Stash the old eval context.
      ...
      if (typeof _context$LWS === 'object' && _context$LWS !== null) {
        ...
        const ownKeys$LWS = shared$LWS.ReflectOwnKeys(_context$LWS);
    ...
    distortionCallback(originalTarget$LWS) {
      ...
      if (shared$LWS.ObjectHasOwn(originalTarget$LWS, 'window') && originalTarget$LWS.window === originalTarget$LWS) {
        ...
        try {
          ...
          _defaultView$LWS = shared$LWS.ReflectApply(sharedDom$LWS.DocumentProtoDefaultViewGetter, originalTarget$LWS, []); // eslint-disable-next-line no-empty
        } catch (_unused41$LWS) {}
...
function getDistortionFactories$LWS(_record$LWS) {
  ...
  ? shared$LWS.ArrayConcat(internalDistortionFactoryInitializers$LWS, internalKeyedDistortionFactoryInitializers$LWS) : shared$LWS.ArrayConcat(externalDistortionFactoryInitializers$LWS, externalKeyedDistortionFactoryInitializers$LWS);
...
function internalEvaluateInSandbox$LWS(evaluateOptions$LWS) {
  ...
  if (typeof __key$LWS !== 'string') {
    throw new shared$LWS.LockerSecurityError('Invalid sandbox key.');
  }
  ...
  const {
  ...
  } = _globalObject$LWS === sharedDom$LWS.rootWindow ? createRootWindowSandboxRecord$LWS({
    context: _context$LWS,
    endowments: endowments$LWS,
    instrumentation: instrumentation$LWS,
    key: __key$LWS,
    ...
    key: __key$LWS,
    type: _type$LWS
  }, rootSandboxRegistry$LWS[__key$LWS]); // Setting the context before evaluating the sourceText so compiled code
  // can wire up import/exports from both sides of the membrane.

  if (_context$LWS !== EMPTY_OBJECT$LWS) {
    if (shared$LWS.ObjectHasOwn(_context$LWS, 'renderer') && shared$LWS.ObjectHasOwn(_context$LWS, 'rendererFactory')) {
      const {
      ...
      if (sandboxedRenderer$LWS === undefined) {
        sandboxedRenderer$LWS = virtualEnvironmentEvaluator$LWS(`'use strict';
                    (${shared$LWS.ReflectApply(shared$LWS.FunctionProtoToString, rendererFactory$LWS, [])})`)(_context$LWS.renderer);
      ...
      shared$LWS.ReflectDeleteProperty(_context$LWS, 'rendererFactory');
    }
...
function proxyWrapFunctionDistortion$LWS({
  ...
  const activityName$LWS = LOCKER_VERBOSE_DEBUG_MODE_INSTRUMENTATION_FLAG$LWS ? factoryName$LWS ? shared$LWS.ReflectApply(shared$LWS.StringProtoReplace, factoryName$LWS, [shared$LWS.LOCKER_IDENTIFIER_MARKER, '']) :
  /* istanbul ignore next: currently unreachable via tests */
  '<unknown>' : undefined;
  const startActivity$LWS = LOCKER_VERBOSE_DEBUG_MODE_INSTRUMENTATION_FLAG$LWS ? instrumentation$LWS.startActivity : undefined;
  const _proxy$LWS = new shared$LWS.ProxyCtor(originalFunc$LWS, shared$LWS.ObjectFreeze({
    apply(__target$LWS, thisArg$LWS, _args$LWS) {
      ...
      try {
        return shared$LWS.ReflectApply(distortedFunc$LWS, thisArg$LWS, _args$LWS);
      } catch (error) {
        // istanbul ignore if: this is a safety precaution that is unreachable via tests
        if (LOCKER_DEBUG_MODE_INSTRUMENTATION_FLAG$LWS) {
          activity$LWS.error({
    ...
    construct(__target$LWS, _args$LWS, newTarget$LWS) {
      ...
      try {
        return shared$LWS.ReflectConstruct(distortedFunc$LWS, _args$LWS, newTarget$LWS);
      } catch (error) {
        // istanbul ignore if: this is a safety precaution that is unreachable via tests
        if (LOCKER_DEBUG_MODE_INSTRUMENTATION_FLAG$LWS) {
          activity$LWS.error({
...
function toSourceText$LWS(__value$LWS, sourceType$LWS) {
  let _sourceText$LWS = typeof __value$LWS === 'function' ? shared$LWS.extractFunctionBodySource(__value$LWS) : shared$LWS.toString(__value$LWS); // We workaround bundlers, like Rollup, aggressively stripping inline source
  ...
  _sourceText$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoReplace, _sourceText$LWS, [// This regexp looks involved, but it prevents browsers and developer
  ...
  /* SourceType.Module */
  && shared$LWS.indexOfPragma(_sourceText$LWS, 'use strict') === -1 ? // Append "'use strict'" to the extracted function body so it is
...
exports.lwsPolicy = lwsPolicy$LWS;
