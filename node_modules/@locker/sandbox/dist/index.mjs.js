 ...
 */
import { toSafeWeakMap as toSafeWeakMap$1$LWS, WeakMapCtor as WeakMapCtor$1$LWS, toSafeMap as toSafeMap$1$LWS, MapCtor as MapCtor$1$LWS, toSafeWeakSet as toSafeWeakSet$LWS, WeakSetCtor as WeakSetCtor$LWS, ReflectGetOwnPropertyDescriptor as ReflectGetOwnPropertyDescriptor$LWS, ReflectSetPrototypeOf as ReflectSetPrototypeOf$1$LWS, ObjectLookupOwnGetter as ObjectLookupOwnGetter$1$LWS, toSafeArray as toSafeArray$1$LWS, ObjectFreeze as ObjectFreeze$1$LWS, ArrayConcat as ArrayConcat$LWS, ObjectLookupOwnSetter as ObjectLookupOwnSetter$LWS, ReflectApply as ReflectApply$1$LWS, alwaysNull as alwaysNull$LWS, StringProtoSplit as StringProtoSplit$LWS, StringProtoReplace as StringProtoReplace$LWS, isConvertibleToString as isConvertibleToString$LWS, prefixNamespace as prefixNamespace$LWS, PromiseProtoThen as PromiseProtoThen$LWS, isNamespacePrefixed as isNamespacePrefixed$LWS, unprefixNamespace as unprefixNamespace$LWS, isObjectLike as isObjectLike$LWS, shallowCloneOptions as shallowCloneOptions$LWS, PromiseReject as PromiseReject$LWS, LockerSecurityError as LockerSecurityError$LWS, StringProtoToLowerCase as StringProtoToLowerCase$LWS, toString as toString$LWS, StringProtoStartsWith as StringProtoStartsWith$LWS, ArrayProtoJoin as ArrayProtoJoin$1$LWS, StringProtoSlice as StringProtoSlice$1$LWS, enquote as enquote$LWS, capitalizeFirstChar as capitalizeFirstChar$LWS, toSafeTemplateStringValue as toSafeTemplateStringValue$LWS, createRevokedProxy as createRevokedProxy$LWS, getNamespacePrefix as getNamespacePrefix$LWS, trackTargetAsLive as trackTargetAsLive$LWS, ObjectAssign as ObjectAssign$1$LWS, ReflectGetPrototypeOf as ReflectGetPrototypeOf$1$LWS, partialStructuredClone as partialStructuredClone$LWS, consoleWarn as consoleWarn$LWS, noop as noop$1$LWS, isObject as isObject$1$LWS, shallowCloneArray as shallowCloneArray$LWS, RegExpProtoTest as RegExpProtoTest$1$LWS, ArrayProtoIndexOf as ArrayProtoIndexOf$1$LWS, ArrayProtoSlice as ArrayProtoSlice$1$LWS, ObjectLookupOwnValue as ObjectLookupOwnValue$LWS, ReflectDefineProperty as ReflectDefineProperty$1$LWS, FunctionProtoBind as FunctionProtoBind$LWS, ReflectDeleteProperty as ReflectDeleteProperty$1$LWS, UNCOMPILED_LOCATION_NAME as UNCOMPILED_LOCATION_NAME$LWS, UNCOMPILED_TOP_NAME as UNCOMPILED_TOP_NAME$LWS, ObjectKeys as ObjectKeys$1$LWS, ProxyCtor as ProxyCtor$LWS, ReflectGet as ReflectGet$LWS, ObjectHasOwn as ObjectHasOwn$1$LWS, ReflectSet as ReflectSet$LWS, ObjectGetOwnPropertySymbols as ObjectGetOwnPropertySymbols$LWS, ReflectHas as ReflectHas$LWS, ArrayCtor as ArrayCtor$1$LWS, ObjectGetOwnPropertyDescriptors as ObjectGetOwnPropertyDescriptors$LWS, NumberIsInteger as NumberIsInteger$1$LWS, SANDBOX_EVAL_CONTEXT_NAME as SANDBOX_EVAL_CONTEXT_NAME$LWS, ErrorCtor as ErrorCtor$1$LWS, FunctionProtoToString as FunctionProtoToString$LWS, extractFunctionBodySource as extractFunctionBodySource$LWS, indexOfPragma as indexOfPragma$LWS, ReflectOwnKeys as ReflectOwnKeys$1$LWS, LOCKER_IDENTIFIER_MARKER as LOCKER_IDENTIFIER_MARKER$1$LWS, ReflectConstruct as ReflectConstruct$LWS, isTargetLive as isTargetLive$LWS, LOCKER_UNMINIFIED_FLAG as LOCKER_UNMINIFIED_FLAG$1$LWS, SANDBOX_EVAL_HELPERS_NAME as SANDBOX_EVAL_HELPERS_NAME$LWS } from '@locker/shared';
import { AttrProtoOwnerElementGetter as AttrProtoOwnerElementGetter$LWS, AttrProtoNameGetter as AttrProtoNameGetter$LWS, AttrProtoNamespaceURIGetter as AttrProtoNamespaceURIGetter$LWS, transformSourceText as transformSourceText$LWS, DocumentProtoCookieGetter as DocumentProtoCookieGetter$LWS, DocumentProtoCookieSetter as DocumentProtoCookieSetter$LWS, NodeProtoNodeNameGetter as NodeProtoNodeNameGetter$LWS, ElementProtoGetAttributeNode as ElementProtoGetAttributeNode$LWS, ElementProtoRemoveAttributeNode as ElementProtoRemoveAttributeNode$LWS, AttrProtoValueGetter as AttrProtoValueGetter$LWS, AttrProtoValueSetter as AttrProtoValueSetter$LWS, ElementProtoGetAttributeNodeNS as ElementProtoGetAttributeNodeNS$LWS, NAMESPACE_XLINK as NAMESPACE_XLINK$LWS, getValidator as getValidator$LWS, NAMESPACE_DEFAULT as NAMESPACE_DEFAULT$LWS, rootValidator as rootValidator$LWS, DocumentProtoHeadGetter as DocumentProtoHeadGetter$LWS, NodeProtoOwnerDocumentGetter as NodeProtoOwnerDocumentGetter$LWS, DOMTokenListProtoValueGetter as DOMTokenListProtoValueGetter$LWS, StorageProtoKey as StorageProtoKey$LWS, StorageProtoGetItem as StorageProtoGetItem$LWS, StorageProtoSetItem as StorageProtoSetItem$LWS, StorageProtoRemoveItem as StorageProtoRemoveItem$LWS, BlobProtoTypeGetter as BlobProtoTypeGetter$LWS, BlobProtoSlice as BlobProtoSlice$LWS, BlobProtoSizeGetter as BlobProtoSizeGetter$LWS, URLRevokeObjectURL as URLRevokeObjectURL$LWS, XhrCtor as XhrCtor$LWS, XhrProtoOpen as XhrProtoOpen$LWS, XhrProtoSend as XhrProtoSend$LWS, XhrProtoResponseTextGetter as XhrProtoResponseTextGetter$LWS, RequestProtoURLGetter as RequestProtoURLGetter$LWS, EventProtoCurrentTargetGetter as EventProtoCurrentTargetGetter$LWS, HTMLIFrameElementProtoSrcSetter as HTMLIFrameElementProtoSrcSetter$LWS, HTMLElementProtoDatasetGetter as HTMLElementProtoDatasetGetter$LWS, DocumentProtoDefaultViewGetter as DocumentProtoDefaultViewGetter$LWS, ElementProtoNamespaceURIGetter as ElementProtoNamespaceURIGetter$LWS, ElementProtoSetAttributeNS as ElementProtoSetAttributeNS$LWS, HTMLAnchorElementProtoHrefSetter as HTMLAnchorElementProtoHrefSetter$LWS, HTMLAnchorElementProtoHrefGetter as HTMLAnchorElementProtoHrefGetter$LWS, HTMLAnchorElementProtoHostnameGetter as HTMLAnchorElementProtoHostnameGetter$LWS, XhrProtoWithCredentialsSetter as XhrProtoWithCredentialsSetter$LWS, EventTargetProtoAddEventListener as EventTargetProtoAddEventListener$LWS, XhrProtoStatusGetter as XhrProtoStatusGetter$LWS, ElementProtoHasAttribute as _ElementProtoHasAttribute$LWS, ElementProtoGetAttribute as ElementProtoGetAttribute$LWS, SVGElementProtoDatasetGetter as SVGElementProtoDatasetGetter$LWS, WindowLengthGetter as WindowLengthGetter$LWS, WindowDecodeURIComponent as WindowDecodeURIComponent$LWS, URLCreateObjectURL as URLCreateObjectURL$LWS, BlobCtor as BlobCtor$LWS, WindowEncodeURIComponent as WindowEncodeURIComponent$LWS, NAMESPACE_XHTML as NAMESPACE_XHTML$LWS, isWindow as isWindow$LWS, WindowFetch as WindowFetch$LWS, ResponseProtoStatus as ResponseProtoStatus$LWS, ResponseProtoStatusText as ResponseProtoStatusText$LWS, ResponseProtoText as ResponseProtoText$LWS, EventCtor as EventCtor$LWS, ErrorEventCtor as ErrorEventCtor$LWS, EventTargetProtoDispatchEvent as EventTargetProtoDispatchEvent$LWS, rootDocument as rootDocument$LWS, IS_WEBKIT_BROWSER as IS_WEBKIT_BROWSER$LWS, rootWindow as rootWindow$1$LWS, WindowFrameElementGetter as WindowFrameElementGetter$LWS, WindowQueueMicrotask as WindowQueueMicrotask$LWS, topWindow as topWindow$LWS, WindowDocumentGetter as WindowDocumentGetter$LWS, WindowLocationGetter as WindowLocationGetter$LWS, IS_CHROMIUM_BROWSER as IS_CHROMIUM_BROWSER$1$LWS, IS_HEADLESS_CHROMIUM_BROWSER as IS_HEADLESS_CHROMIUM_BROWSER$LWS } from '@locker/shared-dom';
...
import { parseURL as parseURL$LWS, isValidURL as isValidURL$LWS, isMIMETypeAllowed as isMIMETypeAllowed$LWS, sanitizeURLForElement as sanitizeURLForElement$LWS, isValidURLScheme as isValidURLScheme$LWS, normalizerAnchor as normalizerAnchor$LWS, TRUSTED_DOMAINS_REG_EXP as TRUSTED_DOMAINS_REG_EXP$LWS, normalizeUrl as normalizeUrl$LWS } from '@locker/shared-url';
...
const recordToAttributeDistortionFactories$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
...
function registerElementSetDistortion$LWS(record$LWS, ElementCtor$LWS, attributeName$LWS, attributeNamespace$LWS, distortion$LWS) {
  ...
  attributeFactories$LWS[attributeFactories$LWS.length] = attributeDistortionRegistry$LWS => {
    ...
    if (elementCtorMap$LWS === undefined) {
      elementCtorMap$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
...
function unprefixCookie$LWS(cookieEntry$LWS, key$LWS) {
  ...
  return ReflectApply$1$LWS(StringProtoSlice$1$LWS, cookieEntry$LWS, [pos$LWS]);
}
/* istanbul ignore next: only available in secure context */
  ...
  return function distortionDocumentCookieSetter$LWS({
    ...
    return [originalCookieSetter$LWS, function set$LWS(value$LWS) {
      ...
      if (newCookieEntry$LWS.length && newCookieEntry$LWS[0] === '=') {
        newCookieEntry$LWS = ReflectApply$1$LWS(StringProtoSlice$1$LWS, newCookieEntry$LWS, [1]);
      }
...
function sanitizeWindowOpenArguments$LWS(args$LWS) {
  ...
  if (sanitizedArgs$LWS.length > 2) {
    ...
    if (ReflectApply$1$LWS(RegExpProtoTest$1$LWS, noopenerRegExp$LWS, [windowFeatures$LWS])) {
...
} = rootValidator$LWS; // The outerText property is non-standard, so the descriptor could be undefined,
...
function isValidRelValue$LWS(value$LWS) {
  return typeof value$LWS !== 'string' || !ReflectApply$1$LWS(RegExpProtoTest$1$LWS, importRegExp$LWS, [value$LWS]);
}
...
function defineEvaluatorProperty$LWS(host$LWS, callback$LWS) {
  if (!ReflectDefineProperty$1$LWS(host$LWS, SCRIPT_EVALUATOR_PROPERTY_NAME$LWS, {
    __proto__: null,
    configurable: true,
...
function createScriptDistortion$LWS({
  ...
  const {
    ...
    [distortionName$LWS](value$LWS) {
      ...
      if (ReflectApply$1$LWS(RegExpProtoTest$1$LWS, TRUSTED_DOMAINS_REG_EXP$LWS, [hostname$LWS])) {
...
function initDistortionJSONParse$LWS({
  ...
  return function distortionJSONParse$LWS({
    ...
    return [originalParse$LWS, function parse$LWS(...args$LWS) {
      const result$LWS = ReflectApply$1$LWS(originalParse$LWS, this, args$LWS);
...
function getStorageKeysForNamespace$LWS(storage$LWS, storageRootKey$LWS) {
  const storageKeys$LWS = ObjectKeys$1$LWS(storage$LWS);
  const keys$LWS = [];
...
function createStorageProxy$LWS(storageTarget$LWS) {
  const proxy$LWS = new ProxyCtor$LWS(storageTarget$LWS, {
    ...
    defineProperty(target$LWS, key$LWS, unsafePartialDesc$LWS) {
      ...
      if (typeof key$LWS === 'symbol') {
        return ReflectDefineProperty$1$LWS(target$LWS, key$LWS, safeDesc$LWS);
      }
      ...
      const keyForNamespace$LWS = getStorageKeyForNamespace$LWS(storageRootKey$LWS, key$LWS);
      return ReflectDefineProperty$1$LWS(storage$LWS, keyForNamespace$LWS, safeDesc$LWS);
    },
...
function createDistortionStorageFactoryInitializer$LWS(storageName$LWS) {
  return function initDistortionStorageFactory$LWS({
    ...
    if (!isObject$1$LWS(originalStorageObject$LWS)) {
      return alwaysNull$LWS;
    }
...
function initDistortionWindowFramesGetter$LWS({
  ...
  const createFramesProxy$LWS = () => {
    ...
    const getFrameByIndexKey$LWS = key$LWS => {
      ...
      if (possibleIndex$LWS > -1 && NumberIsInteger$1$LWS(possibleIndex$LWS) && possibleIndex$LWS < ReflectApply$1$LWS(WindowLengthGetter$LWS, globalObject$LWS, [])) {
...
const policyOptions$LWS = {
  ...
  createScriptURL: (unsafe$LWS, options$LWS) => {
    ...
    if (lwsTTOpts$LWS) {
      ...
      ReflectDefineProperty$1$LWS(targetElement$LWS, 'runScript', {
        // @ts-ignore
        __proto__: null,
        configurable: true,
        get: async () => {
          ReflectDeleteProperty$1$LWS(targetElement$LWS, 'runScript');
          let _event$LWS;
          ...
          try {
            ...
            const _status$LWS = ReflectApply$1$LWS(ResponseProtoStatus$LWS, _response$LWS, []);

            if (_status$LWS !== 200) {
              const text$LWS = ReflectApply$1$LWS(ResponseProtoStatusText$LWS, _response$LWS, []);
              throw new ErrorCtor$1$LWS(text$LWS);
            }

            const text$LWS = await ReflectApply$1$LWS(ResponseProtoText$LWS, _response$LWS, []);
            ...
            ReflectDeleteProperty$1$LWS(targetElement$LWS, 'src');
            ReflectSet$LWS(targetElement$LWS, 'src', _url$LWS);
            ReflectApply$1$LWS(EventTargetProtoDispatchEvent$LWS, targetElement$LWS, [_event$LWS]);
          }
        }
      });
      ...
      ReflectDefineProperty$1$LWS(targetElement$LWS, 'src', {
        // @ts-ignore
        __proto__: null,
        configurable: true,
        enumerable: true,
...
const IFRAME_KEEP_ALIVE_FLAG$LWS = LOCKER_UNMINIFIED_FLAG$1$LWS && IS_CHROMIUM_BROWSER$1$LWS && !IS_HEADLESS_CHROMIUM_BROWSER$LWS; // WebKit based browsers have a bug that prematurely removes distortion entries
// from the distortions weak map.

const SUPPORTS_DISTORTIONS_WEAK_MAP$LWS = !IS_WEBKIT_BROWSER$LWS;
const {
  location: rootLocation$LWS
} = rootWindow$1$LWS; // Fast path non-configurable document, location, and window objects in the
// virtual environment distortion callback by seeding them in the root window's
// created distortion map.

const rootDistortionMapSeedEntries$LWS = [[rootDocument$LWS, rootDocument$LWS], [rootLocation$LWS, rootLocation$LWS], [rootWindow$1$LWS, rootWindow$1$LWS]];
const rootSandboxRegistry$LWS = {
  __proto__: null
};
const documentToSandboxRegistry$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS([[rootDocument$LWS, rootSandboxRegistry$LWS]]));
...
const rendererFactoryToRendererMap$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
...
function createDistortionMap$LWS(entries$LWS) {
  return SUPPORTS_DISTORTIONS_WEAK_MAP$LWS ? toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS(entries$LWS)) : // istanbul ignore next: this code is not reachable in the coverage run.
  ...
  return _sourceText$LWS => {
    if (virtualEnvironment$LWS === undefined) {
      ...
      if (typeof _context$LWS === 'object' && _context$LWS !== null) {
        ...
        const ownKeys$LWS = ReflectOwnKeys$1$LWS(_context$LWS);
...
function internalEvaluateInSandbox$LWS(evaluateOptions$LWS) {
  ...
  } = _globalObject$LWS === rootWindow$1$LWS ? createRootWindowSandboxRecord$LWS({
    context: _context$LWS,
    endowments: endowments$LWS,
    instrumentation: instrumentation$LWS,
    key: __key$LWS,
  ...
  if (_context$LWS !== EMPTY_OBJECT$LWS) {
    if (ObjectHasOwn$1$LWS(_context$LWS, 'renderer') && ObjectHasOwn$1$LWS(_context$LWS, 'rendererFactory')) {
      const {
      ...
      if (sandboxedRenderer$LWS === undefined) {
        sandboxedRenderer$LWS = virtualEnvironmentEvaluator$LWS(`'use strict';
                    (${ReflectApply$1$LWS(FunctionProtoToString$LWS, rendererFactory$LWS, [])})`)(_context$LWS.renderer);
      ...
      ReflectDeleteProperty$1$LWS(_context$LWS, 'rendererFactory');
    }
...
function proxyWrapFunctionDistortion$LWS({
  ...
  const activityName$LWS = LOCKER_VERBOSE_DEBUG_MODE_INSTRUMENTATION_FLAG$LWS ? factoryName$LWS ? ReflectApply$1$LWS(StringProtoReplace$LWS, factoryName$LWS, [LOCKER_IDENTIFIER_MARKER$1$LWS, '']) :
  /* istanbul ignore next: currently unreachable via tests */
  '<unknown>' : undefined;
