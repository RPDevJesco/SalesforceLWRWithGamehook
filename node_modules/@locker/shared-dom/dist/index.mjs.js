...
const IS_HEADLESS_CHROMIUM_BROWSER$LWS = ArrayIsArray$LWS(brands$LWS) && !brands$LWS.length || ReflectApply$LWS(RegExpProtoTest$LWS, headlessChromiumUserAgentRegExp$LWS, [getUserAgent$LWS()]);
const IS_WEBKIT_BROWSER$LWS = !IS_CHROMIUM_BROWSER$LWS && ( // istanbul ignore next: this code is not reachable in the coverage run.
ArrayIsArray$LWS(brands$LWS) && brands$LWS.length ? ReflectApply$LWS(ArrayProtoFind$LWS, brands$LWS, [// istanbul ignore next
item$LWS => {
...
const DOMExceptionProtoCodeGetter$LWS = ObjectLookupOwnGetter$LWS(DOMExceptionProto$LWS, 'code');
const {
...
const EventProtoCurrentTargetGetter$LWS = ObjectLookupOwnGetter$LWS(EventCtor$LWS.prototype, 'currentTarget');
const {
...
function generateContextAssignmentCodeFromContextNames$LWS(names$LWS) {
  return names$LWS.length ? `const {${ReflectApply$LWS(ArrayProtoJoin$LWS, names$LWS, [','])}}=${SANDBOX_EVAL_CONTEXT_NAME$LWS}` : '';
}
