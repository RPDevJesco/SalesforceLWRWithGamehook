...
const ArrayUnscopables$LWS$1 = ObjectFreeze$LWS$1(ObjectAssign$LWS$1({
  __proto__: null
}, ArrayProto$LWS$1[SymbolUnscopables$LWS$1])); // Used by '@locker/near-membrane-dom'.
...
const LOCKER_IDENTIFIER_MARKER$LWS$1 = '$LWS'; // This package is bundled by third-parties that have their own build time
...
/* $LWS */
1}`.includes(LOCKER_IDENTIFIER_MARKER$LWS$1);
...
const UNCOMPILED_LOCATION_NAME$LWS = `uncompiledLocation${LOCKER_IDENTIFIER_MARKER$LWS$1}`;
const UNCOMPILED_TOP_NAME$LWS = `uncompiledTop${LOCKER_IDENTIFIER_MARKER$LWS$1}`;
...
const NumberCtor$LWS$1 = Number; // Used by '@locker/near-membrane-dom'.
...
function toSafeTemplateStringValue$LWS(value$LWS) {
  ...
  try {
    ...
    return StringCtor$LWS$1(value$LWS); // eslint-disable-next-line no-empty
  } catch (_unused2$LWS) {}
...
function getBrandByTrialAndError$LWS(value$LWS) {
  ...
  } catch (_unused5$LWS) {} // Section 24.2.3.9 get Set.prototype.size
  ...
  } catch (_unused6$LWS) {} // Section 24.3.3.4 WeakMap.prototype.has ( key )
  ...
  } catch (_unused7$LWS) {} // Section 24.4.3.4 WeakSet.prototype.has ( value )
  ...
  } catch (_unused8$LWS) {} // The following checks are for the rare occurrence of object, i.e. boxed,
  ...
  } catch (_unused9$LWS) {} // Section 20.4.3 Properties of the Symbol Prototype Object
  ...
  } catch (_unused10$LWS) {} // Perform heavier checks last.
  ...
  } catch (_unused11$LWS) {} // Section 22.1.3 Properties of the String Prototype Object
  ...
  } catch (_unused12$LWS) {} // Section 20.3.3 Properties of the Boolean Prototype Object
  ...
  try {
    ...
    return TO_STRING_BRAND_BOOLEAN$LWS$1; // eslint-disable-next-line no-empty
  } catch (_unused13$LWS) {} // istanbul ignore else: All platforms that LWS runs tests in support BigInt
  ...
  if (SUPPORTS_BIG_INT$LWS) {
    try {
      ...
      return TO_STRING_BRAND_BIG_INT$LWS$1; // eslint-disable-next-line no-empty
    } catch (_unused14$LWS) {}
...
function getNearMembraneSerializedValue$LWS$1(object$LWS) {
...
function isNearMembrane$LWS$1(value$LWS) {
...
const SEEN_OBJECTS_MAP$LWS = toSafeMap$LWS$1(new MapCtor$LWS$1());

function cloneBoxedPrimitive$LWS(object$LWS) {
  return ObjectCtor$LWS$1(getNearMembraneSerializedValue$LWS$1(object$LWS));
}
...
function cloneMap$LWS(map$LWS, queue$LWS) {
  ...
  const clone$LWS = new MapCtor$LWS$1(); // Step 26.1.2: For each Record { [[Key]], [[Value]] } entry of value.[[MapData]]...

  const entriesIterable$LWS = ReflectApply$LWS$1(MapProtoEntries$LWS$1, map$LWS, []); // Step 26.1.3 For each Record { [[Key]], [[Value]] } entry of copiedList:
...
function cloneRegExp$LWS(regexp$LWS) {
  const {
    flags: flags$LWS,
    source: source$LWS
  } = JSONParse$LWS(getNearMembraneSerializedValue$LWS$1(regexp$LWS));
...
function cloneSet$LWS(set$LWS, queue$LWS) {
  ...
  const clone$LWS = new SetCtor$LWS$1(); // Step 26.2.2: For each entry of value.[[SetData]]...
...
function partialStructuredCloneInternal$LWS(value$LWS) {
  ...
  queueLoop: while (queue$LWS.length) {
      ...
      case TO_STRING_BRAND_OBJECT$LWS:
        {
          ...
          if (proto$LWS === ObjectProto$LWS$1 || proto$LWS === null || // Possible `Object.prototype` from another document.
    ...
    if (cloneValue$LWS === undefined) {
      ...
      if (!isNearMembrane$LWS$1(originalValue$LWS)) {
      ...
      switch (brand$LWS) {
        ...
        case TO_STRING_BRAND_BOOLEAN$LWS$1: // Step 8: Otherwise, if value has a [[NumberData]] internal slot...
        // eslint-disable-next-line no-fallthrough

        case TO_STRING_BRAND_NUMBER$LWS$1: // Step 9: Otherwise, if value has a [[BigIntData]] internal slot...
        // eslint-disable-next-line no-fallthrough

        case TO_STRING_BRAND_BIG_INT$LWS$1: // Step 10: Otherwise, if value has a [[StringData]] internal slot...
        // eslint-disable-next-line no-fallthrough
...
/* TargetTraits.None */
  ...
  || target$LWS === null || target$LWS === undefined || target$LWS === ObjectProto$LWS$1 || target$LWS === RegExpProto$LWS$1) {
    return false;
  }
...
function unprefixNamespace$LWS(key$LWS, namespace$LWS) {
  if (typeof key$LWS === 'string') {
    ...
    return ReflectApply$LWS$1(StringProtoStartsWith$LWS, key$LWS, [prefix$LWS]) ? ReflectApply$LWS$1(StringProtoSlice$LWS$1, key$LWS, [prefix$LWS.length]) : key$LWS;
  }
...
const WindowQueueMicrotask$LWS = (() => {
  ...
  } = rootWindow$LWS$1; // istanbul ignore else
...
const rootValidator$LWS = new Validator$LWS(rootWindow$LWS$1, rootDocument$LWS);
...
} = rootWindow$LWS$1; // The user-agent client hints API is experimental and subject to change.
...
const brands$LWS$1 = userAgentData$LWS$1 == null ? void 0 : userAgentData$LWS$1.brands; // Note: Chromium identifies itself as Chrome in its user-agent string.
...
ArrayIsArray$LWS$1(brands$LWS$1) && brands$LWS$1.length ? // Use user-agent client hints API if available to avoid deprecation
// warnings.
...
function generateContextAssignmentCodeFromContextNames$LWS(names$LWS) {
  return names$LWS.length ? `const {${ReflectApply$LWS$1(ArrayProtoJoin$LWS$1, names$LWS, [','])}}=${SANDBOX_EVAL_CONTEXT_NAME$LWS}` : '';
}
...
function initDistortionJSONParse$LWS({
  ...
  return function distortionJSONParse$LWS({
    ...
    return [originalParse$LWS, function parse$LWS(...args$LWS) {
      const result$LWS = ReflectApply$LWS$1(originalParse$LWS, this, args$LWS);
...
function createStorageProxy$LWS(storageTarget$LWS) {
  const proxy$LWS = new ProxyCtor$LWS(storageTarget$LWS, {
    ...
    defineProperty(target$LWS, key$LWS, unsafePartialDesc$LWS) {
      ...
      const keyForNamespace$LWS = getStorageKeyForNamespace$LWS(storageRootKey$LWS, key$LWS);
      return ReflectDefineProperty$LWS$1(storage$LWS, keyForNamespace$LWS, safeDesc$LWS);
    },
