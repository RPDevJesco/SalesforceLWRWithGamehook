...
(function () {
  ...
  class LoaderShim {
      constructor(global) {
          ...
          this.loaderModule = 'lwr/loaderLegacy/v/0_8_8';
  ...
  if (GLOBAL.LWR.requiredModules.indexOf('lwr/loaderLegacy/v/0_8_8') < 0) {
      GLOBAL.LWR.requiredModules.push('lwr/loaderLegacy/v/0_8_8');
  }
  new LoaderShim(GLOBAL);

}());

LWR.define('lwr/loaderLegacy/v/0_8_8', ['exports'], function (exports) { 'use strict';
