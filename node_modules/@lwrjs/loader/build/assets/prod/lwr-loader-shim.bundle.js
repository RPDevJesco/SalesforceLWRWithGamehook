...
(function () {
  ...
  class LoaderShim {
      constructor(global) {
          ...
          this.loaderSpecifier = 'lwr/loader/v/0_8_8';
      ...
      createProfilerModule(loader) {
          ...
          loader.define('lwr/profiler/v/0_8_8', ['exports'], exporter);
      }
  ...
  if (GLOBAL.LWR.requiredModules.indexOf('lwr/loader/v/0_8_8') < 0) {
      GLOBAL.LWR.requiredModules.push('lwr/loader/v/0_8_8');
  }
  new LoaderShim(GLOBAL);

}());

LWR.define('lwr/loader/v/0_8_8', ['exports'], function (exports) { 'use strict';
